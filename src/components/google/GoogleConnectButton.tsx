...
import { useGoogleConnectionStatus, useConnectGoogle, useDisconnectGoogle } from '@/hooks/useGoogleCalendar'

interface GoogleConnectButtonProps {
  returnUrl?: string
}

export function GoogleConnectButton({ returnUrl = '/dashboard' }: GoogleConnectButtonProps) {
